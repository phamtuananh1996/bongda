...
<div class="container page-content edit-profile">
  ...
  <div class="tab-content profile-page">
    ...
    <div class="tab-pane profile active" id="profile-tab">
      ...
      <button id="create" onclick="return false" class="btn btn-custom-primary pull-right"><img id="load" src="images/loader.gif" style="display: none"> Tạo Đội Bóng</button>
...
<script type="text/javascript">
 $(document).ready(function() {
   ...
   $('#ward').change(function(event) {
    ...
    $('#create').addClass('btn-custom-primary').removeClass('btn-primary');
    $('#load').show();
    $.post('ajax/getlongla', {province:province,district:district,ward:ward}, function(data, textStatus, xhr) {
      $('#longtitude').val(data.lng);
      $('#latitude').val(data.lat);
      success:{
        $('#create').attr('onclick', 'return true');
        $('#create').removeClass('btn-custom-primary').addClass('btn-primary');
        $('#load').hide();
      };
    });
